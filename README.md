## ShaderFun Switch - Audio Reactive Visualizer
...
![Screenshot](https://i.ibb.co/Jw3xNsyc/1.jpg)
...
Extract the .nro file to /switch/shaderfun/ on your SD card
...
Note: The can be changed by a program generated file, "sdmc:/switch/shaderfun/ftp_config.txt"
...
Create fragment shaders that react to audio data. Example structure:
...
If you created a stunning audio reactive shader or nice non audio reactive shader and want to share
I can add it to the git, just post a message with your shader code and I'll check it out.

## Disclaimer: This is homebrew software not affiliated with Nintendo. Use at your own risk.
Enjoy the visuals! 🎵✨
...
![Screenshot](https://i.ibb.co/7JSRfwzz/4.jpg)
![Screenshot](https://i.ibb.co/RkZSYXb0/5.jpg)