...
void main() {
    // Convert from vUV to fragCoord-style coordinates
...
Changed the main function signature from:
...
glsl
void main()
Added proper precision and uniforms for your Nintendo Switch environment:
...
uniform float iTime;
varying vec2 vUV;
Converted coordinate system by adding at the start of main():
